  ...
  public: {
    Tables: {
      ...
      gtp_ideas: {
        ...
        Relationships: [
          {
            foreignKeyName: "gtp_ideas_claimed_by_profiles_profile_id_fk"
            columns: ["claimed_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["profile_id"]
      ...
      gtp_ideas_likes: {
        ...
        Relationships: [
          {
            foreignKeyName: "gtp_ideas_likes_gpt_idea_id_gtp_ideas_gpt_idea_id_fk"
            columns: ["gpt_idea_id"]
            isOneToOne: false
            referencedRelation: "gtp_ideas"
            referencedColumns: ["gpt_idea_id"]
          },
          {
            foreignKeyName: "gtp_ideas_likes_profile_id_profiles_profile_id_fk"
            columns: ["profile_id"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["profile_id"]
    ...
    Enums: {
      job_types: "full-time" | "pull-time" | "remote"
